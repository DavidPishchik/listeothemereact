...
import SingleSection1 from './singleSection1';
import SingleSection2 from './singleSection2';
import SingleSection3 from './singleSection3';
      ...
      <div id="wrapper">
        ...
        <div className="listing-slider mfp-gallery-container margin-bottom-0">
          <Slider adaptiveHeight={this.state.adaptiveHeight} {...settings}>
            <div><a href="images/single-listing-04.jpg"> <img className="img-fluid" src="images/single-listing-04.jpg" className="item mfp-gallery" title="Title 1" /></a></div>
            <div><a href="images/single-listing-02.jpg"> <img className="img-fluid" src="images/single-listing-02.jpg" className="item mfp-gallery" title="Title 1" /></a></div>
            <div><a href="images/single-listing-03.jpg"> <img className="img-fluid" src="images/single-listing-03.jpg" className="item mfp-gallery" title="Title 1" /></a></div>
            <div><a href="images/single-listing-04.jpg"> <img className="img-fluid" src="images/single-listing-04.jpg" className="item mfp-gallery" title="Title 1" /></a></div>
          </Slider>
        	...
        	<div className="container">
        		<div className="row">
        			<div className="col-md-5 col-sm-6">
        				...
        				<br/><br/>
        				<p>Morbi convallis bibendum urna ut viverra. Maecenas quis consequat
                  libero, a feugiat eros. Nunc ut lacinia tortor morbi ultricies laoreet ullamcorper phasellus semper.</p>
        			</div>
